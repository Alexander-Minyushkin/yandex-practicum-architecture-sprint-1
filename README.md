...
Все системы общаются между собой только через API Gateway или Message Broker. 
Только платёжная система имеет интеграции с внешними системами.
...
Аналитическая система получает данные из всех микросервисов и агрегирует их для хранения промежуточных данных и отчётов.



Диаграмму с декомпозицией можно найти здесь: [arch_template_task2_v0.02.drawio](./arch_template_task2_v0.02.drawio)
